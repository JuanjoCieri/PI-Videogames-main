...
//         res.send("Game succesfully created!")
//     } catch (e) {
//         console.log(e)
//     }
// })
...
//     let { name, description, create, rating, genres, platforms} = req.body
    
//     // platforms = platforms.join(', ')

//     // if (!platforms || !name || !description) res.status(400).json({msg: "Missing data"})

//     try {
//         const newGame = await Videogame.findOrCreate({              //Busco si no hay un juego ya creado, si no lo hay lo creo
//             where: {
//                 name,
//                 description,
//                 create,
...
//             }
//          })
//          await newGame[0].setGenres(genres)                 //Relaciono id's de generos
//     } catch (e) {
//         console.log(e);
//     }
